...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="icon" href="assets/images/logosewa.png">
                                        ...
                                        <div class="p-5">
                                            <div class="text-center mb-5">
                                                <a href="index.html" class="text-dark font-size-22 font-family-secondary">
                                                    <b class="align-middle">सेवा भारती मध्य भारत</b>
                                                </a>
                                            </div>
                                            ...
                                            <form class="user" method="POST">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Address" name="user">
                                                </div>
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" name="pass">
                                                </div>
                                                <!-- <a href="" class="btn btn-success btn-block waves-effect waves-light" type="submit" name="submit"> Log In </a> -->
                                                <button type="submit" class="btn btn-success btn-block waves-effect waves-light" name="submit">login</button>
