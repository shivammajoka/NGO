    ...
    <div class="footer-top-bar gap">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-4 col-md-6">
            <div class="footer-logo-one">
              <a href="index.html"><img alt="logo" src="assets/img/footer_logo.jpg" width="100px" style="border-radius:50%;"></a>
            </div>
          </div>
        ...
        <div class="Information">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="widget-title">
              <h3 class="m-0"> सेवा भारती मध्य भारत</h3>
              <p class="pt-4">
              देश में जागृत, कर्मठ, समरस, स्वस्थ, स्वावलंबी और 
स्वाभिमानी समाज बनाने के सपने ने सेवा भारती को 
जन्म दिया। सेवा भारती का प्रयास है कि समाजिक 
विकास की पंक्ति में खड़ा अंतिम व्यक्ति को भी 
सम्मान से जीने का अवसर मिले और वह समर्थ 
होकर 
राष्ट्र 
निर्माण में सहभागी बने। सामाजिक 
परिवर्तन के इन्हीं उद्देष्यों को लेकर सेवा भारती 33 
वर्षों से निरन्तर कार्य कर रही है।</p>
            </div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="widget-title">
              ...
              <ul class="pt-4">
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">
शिक्षा</a></li>
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">स्वास्थ्य </a></li>
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">सामाजिक जागरण </a></li>
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">स्वावलम्बन </a></li>
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">प्रचार </a></li>
                <li><i class="fa-solid fa-angle-right"></i><a href="#top-bar">आपदा प्रबंधन </a></li>
                <li class="pb-0"><i class="fa-solid fa-angle-right"></i><a href="#top-bar">प्रशिक्षण</a></li>
              </ul>
            </div>
          </div>
          <div class="col-xl-4 col-md-6">
            ...
            <div class="contact-info mt-4">
              ...
              <h5> मातृछाया परिसर, मैदामिल के पास, होशंगाबाद रोड़, भोपाल-11 म.प्र.</h5>
            </div>
            <div class="contact-info mt-3">
              ...
              <h5>Phone:</h5><a href="callto:800-836-4620">0755-2559597</a>
            </div>
            <div class="contact-info mt-3">
              <i>
              ...
              <h5>Email:</h5><a href="mailto:information@domain.com">swbharti@yahoo.co.in</a>
            </div>
            </div>
          </div>
          </div>
        ...
        <div class="subscribe">
          <div class="d-flex align-items-center">
            ...
            <div class="ps-3">
              <h3>
संपर्क करें</h3>
              <p>swbharti@yahoo.co.in</p>
            </div>
          </div>
          <form>
            <input type="text" name="email" placeholder="Enter your email address...">
            <button class="btn"><span><i class="fa-regular fa-envelope"></i>संपर्क करें</span></button>
          </form>
        </div>
