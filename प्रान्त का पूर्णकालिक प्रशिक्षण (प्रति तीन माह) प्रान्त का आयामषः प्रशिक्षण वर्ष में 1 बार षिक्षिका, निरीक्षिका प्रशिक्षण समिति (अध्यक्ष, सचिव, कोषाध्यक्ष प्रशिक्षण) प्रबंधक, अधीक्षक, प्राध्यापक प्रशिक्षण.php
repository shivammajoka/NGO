...
<section class="page-title-area" style="background-image:url(assets/img/slider-1.png)">
  <div class="container">
    <div class="title-area-data">
      <h2>प्रान्त का पूर्णकालिक प्रशिक्षण (प्रति तीन माह) प्रान्त का आयामषः प्रशिक्षण वर्ष में 1 बार षिक्षिका, निरीक्षिका प्रशिक्षण समिति (अध्यक्ष, सचिव, कोषाध्यक्ष प्रशिक्षण) प्रबंधक, अधीक्षक, प्राध्यापक प्रशिक्षण</h2>
...
<section class="gap">
  <div class="container">
    <div class="event-details hoverimg">
      <figure>
        <img alt="img" src="assets/img/slider-1.png">
      </figure>
      <div class="event-details-text p-100">
        ...
        <div class="row pt-4 pb-4 align-items-center">
            ...
            <div class="organizer">
             <img alt="man" src="https://via.placeholder.com/90x90">
              <div>
                ...
                <h6>Charity Speacker</h6>
              </div>
            </div>
          </div>
          <div class="col-lg-12">
            <p class="pt-4 pb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis au 
            dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat a
            oident, sunt in culpa qui officia deserunt mollit anim id est laborum.<br><br>

            magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris ni si ut aliquip ex eu fugiat nulla pa
            cepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
          </div>
          <div class="col-lg-5">
          ...
          <div class="col-lg-7 ps-sm-5">
            <p class="pb-4">Duis sed odio sit amet nibh vulputate cursus a amet ma san ip
                veli Nam nec tellus a odio tincidunt auct ursus mauris Morbi ac
                msan ipsuy veli Nam nec per tora tor ec tellus. cursus a amet m
                 accumsan ipsuy veli Nam cumsan ipsuy veli Nam nec perus.  a
                Nam nec per tora tor ec tellus. cursus </p>
            <ul class="team-list">
        ...
        <div class="row pt-4">
          <div class="col-lg-4 col-md-4 col-sm-6 hoverimg">
            <div class="event-details-img">
              <figure>
                <img alt="img" class="w-100" src="https://via.placeholder.com/349x365">
              </figure>
            </div>
            <div class="event-details-img">
              <figure>
                <img alt="img" class="w-100" src="https://via.placeholder.com/349x251">
              </figure>
            </div>
          </div>
        ...
        <p class="pt-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
          Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aut
          dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat a
          oident, sunt in culpa qui officia deserunt mollit anim id est laborum.<br><br>
        ...
        <p class="pt-4">
          Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aut dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat a oident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        </p>
