    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        while($row_fetch=mysqli_fetch_assoc($result)){
          echo"
            <ul id='news-content'>
            <li>$row_fetch[news_1]</li>
            <li>$row_fetch[news_2]</li>
            <li>$row_fetch[news_3]</li>
            <li>$row_fetch[news_4]</li>
            <li>$row_fetch[news_5]</li>
            <li>$row_fetch[news_6]</li>
            <li>$row_fetch[news_7]</li>
            <li>$row_fetch[news_8]</li>
            <li>$row_fetch[news_9]</li>
            <li>$row_fetch[news_10]</li>
            <li>$row_fetch[news_11]</li>
            <li>$row_fetch[news_12]</li>
          ";
